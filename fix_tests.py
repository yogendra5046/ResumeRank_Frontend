...
dashboard_test_content = """import 'package:flutter_test/flutter_test.dart';
...
resume_profiles_test_content = """import 'package:flutter_test/flutter_test.dart';
import 'package:resume_ai/features/analysis/domain/entities/analysis_result.dart';
import 'package:resume_ai/features/analysis/data/models/analysis_result_model.dart';
import 'package:resume_ai/features/analysis/presentation/pages/dashboard_page.dart';
...
with open('test/screens/dashboard_screen_test.dart', 'w', encoding='utf-8') as f:
    f.write(dashboard_test_content)
print("Updated dashboard_screen_test.dart")

with open('test/screens/resume_profiles_test.dart', 'w', encoding='utf-8') as f:
    f.write(resume_profiles_test_content)
print("Updated resume_profiles_test.dart")
